    ...
    >
      ...
      {isOwnMessage && !message.isRevoked && (
        <button
          ...
          className="w-full text-left px-4 py-2 hover:bg-slate-800 text-rose-400 hover:text-rose-300 flex items-center gap-2 cursor-pointer transition-colors border-t border-slate-800/80 mt-1"
        >
          <IconTrash size={16} />
